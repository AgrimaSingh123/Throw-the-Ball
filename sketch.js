...
function setup(){
	...
	//top layer
	fill("cyan");
	box1=new Box(390+50,155);

	//second layer
	fill("magenta");
	box2=new Box(360+50,195);
	box3=new Box(390+50,195);
	box4=new Box(420+50,195);


	//third layer
	box5= new Box(330+50,235);
	box6=new Box(360+50,235);
	box7=new Box(390+50,235);
	box8=new Box(420+50,235);
	box9=new Box(450+50,235);
